...
# Suppress non-critical deprecation warnings in terminal
...
PDF_PATH = "islr.pdf"  # change to your file path
...
if __name__ == "__main__":
    print("\nPDF RAG ready. Type 'exit' or 'q' to quit.")
    
    while True:
        q = input("\nQ: ").strip()
        
        # Stop loop if user wants to exit
